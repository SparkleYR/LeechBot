...
async def homepage(request):
    return web.Response(text="<h1>Join Telegram channel <a href=\"https://telegram.dog/touka19\">@Touka19</a> 💙</h1>",content_type="text/html")
